...
if [ ! -e "data/allNounInfl.train.tsv" ]
then
...
# preprocess data
if [ ! -e "data/allNounInfl.train.underlying" ]
then
...
then
    $MARIAN/build/marian \
        ...
        --train-sets data/allNounInfl.train.surface data/allNounInfl.train.underlying \
        ...
        --valid-sets data/allNounInfl.valid.surface data/allNounInfl.valid.underlying \
...
# translate dev set
cat data/allNounInfl.valid.surface \
...
cat data/allNounInfl.testset.surface \
    ...
    | sed 's/\@\@ //g' \
    | ../tools/moses-scripts/scripts/tokenizer/detokenizer.perl -l en \
    > data/allNounInfl.testset.output

# calculate bleu scores on dev and test set
#../tools/moses-scripts/scripts/generic/multi-bleu-detok.perl data/allNounInfl.valid.underlying < data/allNounInfl.valid.output
#../tools/moses-scripts/scripts/generic/multi-bleu-detok.perl data/allNounInfl.testset.underlying < data/allNounInfl.testset.output
